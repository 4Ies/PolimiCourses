...
\begin{itemize}
    \item \textbf{Guessing} - an attacker can guess a password by identifying 
    similar common patterns between different passwords 
...
but carries a lot of problems: it's \textbf{hard to deploy} and most 
importantly \textbf{hard to share} at the start of the "conversation". 
There are many classic tecnologies that try to cope with those problems:
\begin{itemize}
